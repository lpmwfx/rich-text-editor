...
const COLOR_BOLD: u32 = 0xFFf5e0dc;
const COLOR_ITALIC: u32 = 0xFFf5c2e7;
const COLOR_CODE: u32 = 0xFFa6e3a1;
const COLOR_LINK: u32 = 0xFF89dceb;
...
pub fn tokenize(doc: &Document) -> (Vec<FlatRichToken>, i32) {
...
mod tests {
    ...
    fn tokenize_bold_italic() {
        let doc = Document::from_markdown("**bold** and *italic*");
    ...
    fn tokenize_bullet_list() {
        let doc = Document::from_markdown("- one\n- two");
        let (tokens, _) = tokenize(&doc);
